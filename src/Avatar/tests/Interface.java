...
public class Interface {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        Player player = new Player(moi.spawnX, moi.spawnY, 180, playerHitbox, hiveZone, spawnZone, monsters, pseudo);
        player.setMovementBounds(0, 0, windowWidth - playerHitbox.getWidth(), windowHeight - playerHitbox.getHeight()); // éviter de sortir de l'écran
